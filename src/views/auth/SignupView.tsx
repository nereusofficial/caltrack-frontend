...
const SignupView = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden bg-[#010b16] flex items-center justify-center p-4 sm:p-8">
      <AuthCanvas />
      ...
      <AuthPanel maxWidth="max-w-[580px]" compact>
        ...
        <h1 className="mb-0.5 text-center text-3xl sm:text-4xl font-light uppercase tracking-[0.18em] text-[#c8eeff]"
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-2 border-t border-[rgba(0,120,180,0.15)] pt-3">
