...
const DashboardSidebar = ({ open = true, onClose }: DashboardSidebarProps) => {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed top-0 left-0 z-30 h-full w-[240px] flex-shrink-0 flex-col
        border-r border-[rgba(0,180,255,0.1)] bg-[rgba(1,12,28,0.98)]
      ...
      `}>
        ...
        <div className="border-t border-[rgba(0,180,255,0.08)] p-3">
          ...
          >
            <span className="pointer-events-none absolute left-0 top-[6px] bottom-[6px] w-[2px] bg-[#00d4ff] opacity-0 transition-opacity duration-150 group-hover:opacity-100"
