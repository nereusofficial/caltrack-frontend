...
const StatusWindow = () => (
  <>
    {stats.map(({ key, val, unit, color }) => (
      <div key={key} className="relative border border-[rgba(0,180,255,0.15)] bg-[rgba(1,16,38,0.92)] px-4 py-4 flex-1 min-w-0">
        ...
        <div className="mt-1 text-[1.4rem] sm:text-[1.6rem] font-semibold leading-none" style={{ color }}>{val}</div>
